...
class ErrorCode(StrEnum):
    ...
    # v1.0.1: the challenge was generated by a withdrawn historical generator
    # (REPO-v0.1 generator 0.1.0) whose verifier semantics allowed
    # candidate-side expected-value access; it is refused, never reinterpreted.
    WITHDRAWN_GENERATOR = "WITHDRAWN_GENERATOR"
